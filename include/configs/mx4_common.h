/*
 * Copyright (C) 2014 Host Mobility AB
 * Portions Copyright (C) 2012 Toradex, Inc.
...
#ifndef __MX4_COMMON_H
#define __MX4_COMMON_H
...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE (2 << 20) /* 2 MB */
