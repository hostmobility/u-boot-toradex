...
#define SPI_CMD_IDLE_SCLK_DRIVE_LOW		(0 << 24)
#define SPI_CMD_IDLE_SCLK_DRIVE_HIGH	(1 << 24)
#define SPI_CMD_IDLE_SCLK_PULL_LOW		(2 << 24)
#define SPI_CMD_IDLE_SCLK_PULL_HIGH		(3 << 24)
#define SPI_CMD_IDLE_SCLK_MASK			(3 << 24)
