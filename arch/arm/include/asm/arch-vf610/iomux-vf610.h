...
enum {
    ...
    /**/
	VF610_PAD_PTD5__DSPI1_CS0		= IOMUX_PAD(0x0150, 0x0150, 3, 0x0300, 1, VF610_DSPI_PAD_CTRL),
	VF610_PAD_PTD6__DSPI1_SIN		= IOMUX_PAD(0x0154, 0x0154, 3, 0x02fc, 1, VF610_DSPI_SIN_PAD_CTRL),
	VF610_PAD_PTD7__DSPI1_SOUT		= IOMUX_PAD(0x0158, 0x0158, 3, __NA_, 0, VF610_DSPI_PAD_CTRL),
	VF610_PAD_PTD8__DSPI1_SCK		= IOMUX_PAD(0x015c, 0x015c, 3, 0x02f8, 1, VF610_DSPI_PAD_CTRL),
    /**/
